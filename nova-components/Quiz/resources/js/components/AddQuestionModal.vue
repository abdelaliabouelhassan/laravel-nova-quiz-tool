            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 space-y-5">
                ...
                <div class=" w-full p-5 space-y-6">
                    ...
                    <div class=" w-full flex flex-col items-start space-y-5">
                        <div class=" flex items-center space-x-4 w-full" v-for="(item,index,key) in question.questions[QuestionIndex].answers" :key="key">
...
<script setup>
 ...
 const SetIsCorrect = (item) => {
  ...
  props.question.questions[props.QuestionIndex].answers.forEach(element => {
  ...
  const Save = () => {
    ...
    let is_correct = props.question.questions[props.QuestionIndex].answers.find(item => item.is_correct == true)
    ...
    let has_answer = props.question.questions[props.QuestionIndex].answers.find(item => item.answer == '')
    if(has_answer){
  ...
  const RemoveAnswer = (item) => {
    let index = props.question.questions[props.QuestionIndex].answers.indexOf(item)
